...
public class TssSetAppointment extends AppCompatActivity {
    ...
    public void  SaveAppointmetToArray(AndroidAppointment appointment, Integer ID) throws JSONException {
        ...
        try {
            ...
            String storesString = Local.Get(getApplicationContext(), "AndroidTssAppointments");
            ...
            Local.Set(getApplicationContext(), "AndroidTssAppointments", JsonUtil.convertAppointmentArrayToJson(appointments));
