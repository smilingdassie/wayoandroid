...
public class InstallGridViewUnitary extends  ArrayAdapter <AndroidStoreUnitExplicit> {
...
//    ViewHolderItem viewHolder;
    ...
    public InstallGridViewUnitary(Context context, ArrayList<AndroidStoreUnitExplicit> data, boolean mIsSurvey )
    {
        super(context, 0);
    ...
    if (convertView == null) {
        ...
        row = inflater.inflate(R.layout.new_grid_upload, parent, false);
