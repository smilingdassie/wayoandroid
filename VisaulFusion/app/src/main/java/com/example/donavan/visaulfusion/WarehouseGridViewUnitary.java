...
public class WarehouseGridViewUnitary extends ArrayAdapter <AndroidStoreUnit> {
    ...
    public WarehouseGridViewUnitary(Context context, ArrayList<AndroidStoreUnit> data)
    {
        super(context, 0);
