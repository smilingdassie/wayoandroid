...
public class InstallGridViewRequests extends  ArrayAdapter <AndroidOpenRequest> {

    Context context;
    private ArrayList<AndroidOpenRequest> data = new ArrayList<AndroidOpenRequest>();


    public InstallGridViewRequests(Context context, ArrayList<AndroidOpenRequest> data)
    {
        super(context, 0);
