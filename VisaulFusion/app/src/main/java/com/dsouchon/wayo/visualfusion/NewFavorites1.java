...
public class NewFavorites1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager.setValue( "StoreID", String.format("%s",(me.getIntExtra("StoreID", 0))));
        dbManager.setValue( "URN", me.getStringExtra("URN"));
    ...
    public void Continue(View view) {
        ...
        dbManager.setValue( "PRS1", Integer.toString(mPRS));
