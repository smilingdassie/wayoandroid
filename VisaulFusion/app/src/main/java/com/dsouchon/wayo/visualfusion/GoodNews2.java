...
public class GoodNews2 extends AppCompatActivity {

    private DBManager dbManager;

    public void onBackPressed() {
        //DO NOTHING
        Intent intent = new Intent(GoodNews2.this, LoginActivity.class );
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      catch (Exception e)
      {
          ...
          Intent intent = new Intent(GoodNews2.this, GoodNews3.class );
          startActivity(intent); finish();
      }
