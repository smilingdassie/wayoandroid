...
/**
 * Created by Daniel on 2018/05/09.
 */
...
public class ImageAdapter extends ArrayAdapter<AndroidStoreUnitExplicit> {
    private Context mContext;
    private ArrayList<AndroidStoreUnitExplicit> data = new ArrayList<AndroidStoreUnitExplicit>();
    private boolean mIsSurvey;

    static class ViewHolder {
        TextView txtItemTypeName;
        TextView txtBarcode;
        TextView txtCount;
        ImageView imageViewAndroid;
        TextView txtQuantitySelected;
        TextView txtMaxQuantity;
    }

    public ImageAdapter(Context c, ArrayList<AndroidStoreUnitExplicit> data, boolean mIsSurvey ) {
        super(c, 0);
        this.mContext=c;
        this.data = data;
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
      ...
      //  LayoutInflater inflater = (LayoutInflater) mContext                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        if (convertView == null) {
            ...
            holder.txtItemTypeName = (TextView) convertView.findViewById(R.id.txtItemTypeName);
            ...
            holder.txtQuantitySelected = (TextView) convertView.findViewById(R.id.txtQuantitySelected);
            holder.txtMaxQuantity = (TextView) convertView.findViewById(R.id.txtMaxQuantity);
        ...
        AndroidStoreUnitExplicit item = data.get(i);
        Integer imagecount = item.getImageCount();
        holder.txtCount.setText("Imgs: " +imagecount.toString());
        if(mIsSurvey) {
            //TextView txtQuantitySelected = (TextView) gridViewAndroid.findViewById(R.id.txtQuantitySelected);
            holder.txtQuantitySelected.setText("Qty: " + Integer.toString(item.getQuantitySelected()));

            //TextView txtMaxQuantity = (TextView) gridViewAndroid.findViewById(R.id.txtMaxQuantity);
            holder.txtMaxQuantity.setText("Max: " + Integer.toString(item.getMaxQuantityFromMatrix()));
        }
        //ImageView imageViewAndroid = (ImageView) gridViewAndroid.findViewById(R.id.android_gridview_image);
        holder.imageViewAndroid.setImageResource(getImageFromDrawables(item.getImagePath()));
        holder.txtItemTypeName.setText(item.getItemTypeName());

        //TextView txtBarcode = (TextView) gridViewAndroid.findViewById(R.id.txtBarcode);
        if(!mIsSurvey) {
        ...
        {
            String YN = "?";
            switch(item.getAcceptedByStore())
            {
                case -1: YN = "?"; break;
                case 0: YN = "N";break;
                case 1: YN = "Y";break;
            ...
            holder.txtBarcode.setText("OK: "+ YN);
