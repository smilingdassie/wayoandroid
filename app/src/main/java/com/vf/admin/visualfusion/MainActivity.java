...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.scan_home) {
            ...
            Toast.makeText(this,"this is  fragment two", Toast.LENGTH_LONG).show();
            FragmentSecondScreen Gallery = new FragmentSecondScreen();
            FragmentManager manager = getFragmentManager();
            manager.beginTransaction().replace(R.id.Linearlayot_for_fragment, Gallery, Gallery.getTag()).commit();
